                    ...
                    <ul>
                        ...
                        </div>
                        {
                            ...
                            budgetItems.map((item, index) =>(
                                <li key = {index} className = "row w-40 mx-auto text-center mt-2">
                        ...
                        <div className = "card" class = "individGraph" id="firstGraph">
                            ...
                            <ResponsiveContainer height={300}>
                                ...
                                >
                                    ...
                                    <Tooltip/>
                                    <Legend />
                                    <Bar dataKey= "val" fill="rgba(127, 125, 247, 0.884)" name="Dollars Spent"/>
                                </BarChart>
                            </ResponsiveContainer>
                        ...
                        <div className = "card" class = "individGraph" id="secondGraph">
                            ...
                            <ResponsiveContainer  height={300}>
                                ...
                                >
                                    ...
                                    <Tooltip/>
                                    <Legend />
                                    <Bar dataKey= "ct" fill="rgba(127, 125, 247, 0.884)" name="Count"/>
                                </BarChart>
                            </ResponsiveContainer>
                        </div>
